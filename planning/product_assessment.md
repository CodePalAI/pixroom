...
| Real Claude Code MCP gateway gate, one synthetic unfilterable tool | 81,665-character structured result -> 508-character artifact result; expected artifact id asserted; exact answer; 4 turns; $0.020339 | Pinpoint MCP firewall + QCV store | The upstream boundary, strict Claude MCP schemas, nested collection discovery, and autonomous exact follow-up work together for one real client task |
