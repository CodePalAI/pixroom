...
| E6 | Durable authority | Operator identity or transparency-log anchoring provides verifiable continuity beyond an ephemeral gateway session | **OPEN / BLOCKING** | Session keys only |
...
new authority infrastructure. Calling the result "proven" before those gates close
would be circular.
