...
- Persistent authority-key creation and loading currently fail closed on Windows because Pinpoint does not yet install or verify a restrictive file DACL. Use a POSIX deployment or an external signing boundary for operator-rooted receipts.
